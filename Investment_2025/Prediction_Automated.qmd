...
split_date <- as.Date("2023-01-01")  # Example split date
...
# Display logistic regression model summary
...
# --- Manually construct today's feature row (based on latest available data) ---
recent_returns <- tail(returns_df, 5)

r_lag1 <- recent_returns$return[5]  # yesterday
...
# --- Model vs Actual (yesterday's result) ---
